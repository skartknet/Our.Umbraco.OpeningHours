angular.module("umbraco").controller("openingHours.controllers.OpeningHoursController", function ($scope, localizationService) {
    ...
    var weekdayConfig = { label: "", alias: "", day: 0, opens: "09:00", closes: "17:00", isOpen: true };
    var holidayConfig = { label: "", alias: "", date: { view: 'datepicker', config: datePickerConfig, value: defaultHolidayDate }, opens: "09:00", closes: "17:00", isOpen: true };
